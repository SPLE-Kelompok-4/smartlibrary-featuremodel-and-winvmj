...
public abstract class EBookAccessServiceComponent implements Service {
    ...
    public abstract EBookAccess create(Map<String, Object> requestBody);
    public abstract EBookAccess create(Map<String, Object> requestBody, Map<String, Object> response);    
