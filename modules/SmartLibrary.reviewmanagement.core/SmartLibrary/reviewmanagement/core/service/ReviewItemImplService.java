...
//             return null;
//         }
//         ReviewItem reviewitem = createReviewItem(vmjExchange);
//         reviewitemRepository.saveObject(reviewitem);
//         return getAllReviewItem(vmjExchange);
//     }
//     // @Restriced(permission = "")
...
//     }
//     public ReviewItem createReviewItem(VMJExchange vmjExchange){
//         if (vmjExchange.getHttpMethod().equals("POST")) {
//             Map<String, Object> requestBody = vmjExchange.getPayload(); 
//             ReviewItem result = reviewitemServiceImpl.createReviewItem(requestBody);
//             return result.toHashMap();
...
//         throw new NotFoundException("Route tidak ditemukan");
//     }
//     public ReviewItem createReviewItem(VMJExchange vmjExchange, int id){
//         if (vmjExchange.getHttpMethod().equals("POST")) {
//             Map<String, Object> requestBody = vmjExchange.getPayload(); 
//             ReviewItem result = reviewitemServiceImpl.createReviewItem(requestBody, id);
//             return result.toHashMap();
//         }
//         throw new NotFoundException("Route tidak ditemukan");
//     }
...
//             return null;
//         }
//         ReviewItem reviewitem = reviewitemServiceImpl.updateReviewItem(requestBody);
//         return reviewitem.toHashMap();
//     }
//     public HashMap<String, Object> getReviewItem(Map<String, Object> requestBody){
//         UUID id = UUID.fromString((String) requestBody.get("id"));
//         Map<String,Object> req = new HashMap<>();
//         req.put("table_name", "reviewitem_impl");

//         List<HashMap<String,Object>> reviewitemList =
//             getAllReviewItem(req);
//         for (HashMap<String, Object> reviewitem : reviewitemList){
//             UUID record_id = (UUID) reviewitem.get("record_id");
//             if (record_id == id){
//                 return reviewitem;
//             }
//         }
//         return null;
//     }
//     public HashMap<String, Object> getReviewItemById(UUID id){
//         ReviewItem reviewitem = reviewitemRepository.getObject(id);
//         return reviewitem.toHashMap();
//     }
//     // @Restriced(permission = "")
...
//         String table = (String) requestBody.get("table_name");
//         List<ReviewItem> list = reviewitemRepository.getAllObject(table);
//         return transformListToHashMap(list);
//     }
...
//         String idStr = ((String) requestBody.get("id"));
//         int id = Integer.parseInt(idStr);
//         reviewitemRepository.deleteObject(id);
